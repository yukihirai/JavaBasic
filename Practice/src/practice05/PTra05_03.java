...
public class PTra05_03 {
	public static void main(String[] args) {
		...
		// ★ 変数mountain、river、oceanの中で最も票を集めたところを出力してください
        if(mountain>=3){
        ...
        }else if(mountain==2 && river==2) {
        	System.out.println("山と川");
        }else if(mountain==2 && ocean==2) {
        	System.out.println("山と海");
        }else if(river==2 && ocean==2) {
        	System.out.println("川と海");
        }
